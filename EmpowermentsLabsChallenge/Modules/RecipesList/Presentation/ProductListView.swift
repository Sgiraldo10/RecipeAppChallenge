...
final class ProductListView: UIView, ProductListViewType {
    ...
    lazy var searchProductBar: UISearchBar = {
        ...
        view.placeholder = "Buscar receta"
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    lazy var searchComponent: SearchComponentViewType = {
        ...
        view.setTitle("Buscar en Spoonacular")
        view.setDescription("Encuentra tus recetas favoritas.")
    ...
    private func setupSearchComponent() {
        ...
        NSLayoutConstraint.activate([
            ...
            searchComponent.centerYAnchor.constraint(equalTo: centerYAnchor),
        ])
    }
...
extension ProductListView {
    ...
    func cancelSearchBar() {
        searchProductBar.setShowsCancelButton(false, animated: true)
        searchProductBar.text = ""
        searchProductBar.resignFirstResponder()
    }

    func setSearchComponentDescription(_ description: String) {
        searchComponent.setDescription(description)
    }
